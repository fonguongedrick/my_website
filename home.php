...
<body data-spy="scroll" data-target="#main-navbar" data-offset="75">
	...
	<div class="preloader">
		<div class="loader">
			<div class="diamon">
				<img src="images/1495.gif" alt="D3man" class="img-fluid">
			</div>
		</div>
	</div>
	<!-- Preloader Ends -->
					...
					<div class="banner-content">
						<h2 class="cd-headline clip">
							...
							<span class="cd-words-wrapper">
								<b class="is-visible">Flutter Developer</b>
								<b>Community Builder</b>
							</span>
						</h2>
						<h5>I am delighted to meet you</h5>
			...
			<div class="row">
				<div class="col-lg-4">
					...
					<div class="about-image wow fadeInLeft" data-wow-delay="0.3s">
						<img src="images/d3man2.jpeg" alt="D3man" />
					</div>
					<!-- About image end -->
				</div>
				...
				<div class="col-lg-8">
					...
					<div class="about-content wow fadeInUp" data-wow-delay="0.8s">
						<h3>I'm Fonguong Edrick N</h3>
						<p>Edrick, a natural tinkerer from Ndop, a rural village known for its rice fields, discovered his passion for coding through a smartphone and online tutorials. This self-taught Flutter developer now builds mobile apps specifically designed to address the needs of his community. From connecting farmers directly with rice buyers to creating platforms for local weavers, Edrick's apps bridge the gap between technology and cultural relevance. His dedication extends beyond his own projects, as he actively contributes to open-source initiatives focused on empowering rural communities.</p>

						<ul>
							<li><i class="flaticon-flag"></i><b>Nationality:</b> Cameroonian</li>
							<li><i class="flaticon-freelance"></i><b>Developer:</b> Available</li>
							<li><i class="flaticon-phone-call"></i><b>Phone:</b> +237 80692014</li>
							<li><i class="flaticon-placeholder"></i><b>Address:</b> Northwest, Bambui</li>
							<li><i class="flaticon-email"></i><b>Email:</b> fongedri@gmail.com</li>
							<li><i class="flaticon-translation"></i><b>Spoken Langages:</b> English</li>
							<!-- <li><i class="flaticon-skype"></i><b>Skype:</b> jesica.silva</li> -->
						</ul>
					</div>
					<!-- About Content End -->
				</div>
							...
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide">
									<div class="experience-single">
										<h5>2004 - 2006</h5>
										<h4>UI/UX Developer - Themeforest</h4>
								...
								<div class="swiper-slide">
									<div class="experience-single">
										<h5>2006 - 2010</h5>
										<h4>Graphics Designer - Themeforest</h4>
										<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna.</p>
									</div>
								</div>
								<!-- Experience Slide end -->
		...
		<div class="container">
			<div class="row">
				<div class="col-md-12">
					...
					<div class="section-title">
						<h2>Latest News</h2>
						<p>Latest Post - Lorem ipsum dolor</p>
					</div>
					<!-- Section title end -->
				</div>
			</div>
					...
					<div class="blog-single wow fadeInUp" data-wow-delay="0.3s">
						...
						<div class="blog-footer">
							<ul>
								...
								<li><i class="fa fa-eye"></i>Read More</li>
							</ul>
						</div>
					</div>
					<!-- Blog Single End -->
